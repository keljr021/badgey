...
<template>
    <div @mouseleave="hideSubmenus()">
        <div v-if="userLoggedIn">    
            <div class="desktop">
                <UButton v-if="loggedInUser.userType === '3'" @click="$router.push({ name: 'admin' })" @mouseover="hideSubmenus()" color="neutral" variant="link" size="md" class="nav-links-item hover:text-black mr-3">Admin</UButton>
